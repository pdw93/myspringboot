package com.ssnail.myspringboot.utils;
...
public class StringUtils {
    ...
    /**
     * 根据分隔符将字符串分割后将单词首字母处理成大写后拼接返回
     *
     * @param words 待处理的字符串
     * @param split 指定分隔符，默认 "_"
     * @return 处理后的字符串
     */
    public static String makeAllWordFirstLetterUpperCase(String words, String split) {
        String[] strs = words.toLowerCase().split(isBlank(split) ? "_" : split);
        String result = "";
        String preStr = "";
    ...
    public static String toJavaClassName(String str) {
        return makeAllWordFirstLetterUpperCase(StringUtils.toUnderscoreName(str), null);
    }
